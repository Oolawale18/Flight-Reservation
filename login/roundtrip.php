...
<div id="menubar-id">
        ...
        <div class="quick_book">
            <h3 id="booking_header"> Round Trip Search Results</h3>
        </div>
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $return = $_POST['return'];
     ...
     $query2 = "select * from bookings where (departure = '$to') AND (destination = '$from') AND (date = '$return')";
    ...
    if($rowcount2 > 0){
        ...
        echo '<td>
            ...
            <input type = "hidden" name = "flight2_id" value = "'.$row2['reserve_id'].'">
